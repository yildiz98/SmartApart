const CACHE_NAME='emfe3-smartapart-v18-firebase-fix-cache';
const FILES=['./','./index.html','./style.css?v=18.0','./app.js?v=18.0','./firebase-config.js?v=18.0','./manifest.json','./icon.svg','./logo.png'];
